<?php namespace Yunicot\Laravelfilemanager\controllers;

use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Yunicot\Laravelfilemanager\controllers\Controller;
...
use Yunicot\Laravelfilemanager\Events\ImageWasUploaded;
...
class UploadController extends LfmController {
    ...
    public function upload()
    {
        ...
        \Storage::disk('s3')->put($dest_path.$new_filename, file_get_contents($file));
    ...
    private function makeThumb($dest_path, $new_filename)
    {
        ...
        $thumb_img = Image::make(Storage::disk('s3')->get($dest_path.$new_filename));
        $thumb_img->fit(200, 200);
        Storage::disk('s3')->put($dest_path . $thumb_folder_name . '/' . $new_filename, $thumb_img->stream()->__toString());
        unset($thumb_img);
    }
